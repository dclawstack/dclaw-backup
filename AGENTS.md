...
**DClaw Backup** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8032` (FastAPI)
- **Frontend Port:** `3032` (Next.js)
- **Database:** `dclaw_backup` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3032`
